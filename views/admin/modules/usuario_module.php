        ...
        <div class="card-body">
            ...
            <form class="forms-sample" id="formUsuario">
                <div class="form-group border-top pt-4">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <input disabled type="text" class="form-control" value="<?php echo $_SESSION["userLoggedRolText"] ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group border-top pt-4">
                ...
                <div class="form-group border-top pt-4">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <input disabled type="email" class="form-control" id="inputEmail" placeholder="example@dominio.com" value="<?php echo $usuarioBase->correo; ?>">
                        </div>
                        <div class="col-3">
                            <button type="button" data-action-button="edit" class="btn btn-primary ">editar</button>
                        </div>
