      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
            ...
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                  <a class="nav-link btn-suc" href="<?php echo URL_BASE_APP ?>contactanos">Contáctanos</a>
               </li>
               <li class="nav-item">
               ...
               <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                     <li><a class="dropdown-item" href="<?php echo URL_BASE_APP; ?>iniciar-sesion">Iniciar Sesión </a></li>
                     <li><a class="dropdown-item" href="<?php echo URL_BASE_APP; ?>registrarse">Regístrate</a></li>
                  </ul>
               </li>
            </ul>
         </div>
